      ...
      <div className="max-w-2xl mx-auto px-4 relative z-10 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-4 group items-center">
            {/* QR Code Placeholder */}
            <div className="w-full max-w-[160px] mx-auto aspect-square bg-white/5 border border-green-500/30 rounded-xl p-2 relative overflow-hidden backdrop-blur-sm shadow-[0_0_20px_rgba(74,222,128,0.05)] group-hover:shadow-[0_0_30px_rgba(74,222,128,0.2)] transition-all">
               {/* Scan Animation */}
               ...
               <div className="w-full h-full border-2 border-dashed border-green-500/20 rounded-lg flex items-center justify-center bg-black/40 overflow-hidden relative">
                  ...
                  <img 
                    src={lineQrUrl} 
                    className="absolute inset-0 w-full h-full object-contain z-20 bg-white p-2" 
                    alt="Line QR Code"
                  />
               </div>
            </div>
